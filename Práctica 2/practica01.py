...
def test_gradient_descent_multi(x_train, y_train):
      ...
      numSucces = GetNumGradientsSuccess(w2,w2Sol,b2,b2Sol)

      assert numSucces == (len(w2Sol)+1), f"Case 2: w2,b2 is wrong: {w2},{b2} != {w2Sol},{b2Sol}"
...
# Pruebas para regresión lineal simple
...
# Probar el resultado del descenso de gradiente
...
# Cargar datos para regresión multivariable
...
# Pruebas para regresión lineal multivariable
